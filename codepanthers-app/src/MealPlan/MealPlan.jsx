...
const [selectedDessert, setSelectedDessert] = useState(null);
  ...
  const handleMealChange = (meal, category) => {
    ...
    if (currentSelections[category][meal]) {
      selectionActions[category]((prevState) => ({
        ...prevState,
        [meal]: false,
      }));
    } else if (
      Object.values(currentSelections[category]).some((value) => value)
    ) {
      ...
      selectionActions[category]({
        ...Object.keys(currentSelections[category]).reduce(
    ...
    const userChoice = { meal, category };
    setUserChoice(userChoice);
    console.log(userChoice);


    selectionStateActions[category]((prevState) => ({
        ...Object.keys(prevState).reduce((acc, key) => ({ ...acc, [key]: false }), {}),
        [meal]: true,
      }));
  
      selectionActions[category](meal);
  };
  ...
  return (
    <>
      ...
      {showDietaryPopup && <DietaryPopup onClose={handleHideDietaryPopup} />}
            ...
            <div>
              ...
              <div className="card">
                ...
                <div className="card-content">
                  ...
                  <p className="card-details">
                    Skewers with a mix of fresh fruit, like melon, berries, and
                    grapes, can serve as a refreshing and healthy appetizer.
                  </p>
                </div>
              </div>
            </div>
              ...
              {userChoice.meal === "gyro" && (
                <div className="card">
                  ...
                  <div className="card-content">
                    ...
                    <p className="card-details">
                      Seasoned meat (beef, lamb, or chicken) in warm pita with
                      tzatziki, tomatoes, onions, lettuce. Optional: feta,
